...
async function deleteAdmin() {
  ...
  try {
    ...
    if (confirmEnv !== 'yes') {
      console.log('❌ Deletion cancelled. Set CONFIRM_DELETE=yes environment variable to confirm deletion.');
      console.log('Example: CONFIRM_DELETE=yes node scripts/delete-admin.js admin');
      process.exit(1);
    }
