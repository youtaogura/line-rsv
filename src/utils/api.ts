...
export function createApiResponse(data: unknown, status: number = HTTP_STATUS.OK) {
  return NextResponse.json(data, { status });
}

export function createErrorResponse(message: string, status: number = HTTP_STATUS.INTERNAL_SERVER_ERROR) {
